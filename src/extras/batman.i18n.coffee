class Batman.I18N extends Batman.Object
  ...
  @translate: (key, values) ->
    ...
    if ! translation?
      Batman.developer.warn "Warning, undefined translation #{key} when in local #{@get('locale')}" if BATMAN_DEBUG
      return ""
  ...
  constructor: -> Batman.developer.error "Can't instantiate i18n!" if BATMAN_DEBUG
